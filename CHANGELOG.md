...
- New JSON Schema validation options supported for strings, numbers and const (see [#18](https://github.com/cyrilletuzi/angular-async-local-storage/issues/18) for the full list).
